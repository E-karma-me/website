            ...
            <div className="navbar">
                <nav>
                    ...
                    <ul className={isMenuOpen ? "open" : ""}>
                        ...
                        <li><a href="#team" onClick={toggleMenu}>Meet the Team</a></li>
            ...
            <section id="home">
                <div className="hero">
                    <div className="heroOverlay">
                        ...
                        <button data-tally-open="mBBWN1" data-tally-overlay="1" data-tally-emoji-text="👋" data-tally-emoji-animation="wave" className="pickupButton">Schedule a Pickup</button>
                    </div>
                </div>
            </section>

            <section id="about">
                <div className="about" style={{font: "Times new roman"}}>
                    <h1><b>About Us</b></h1>
                    <p className="AP1">
                ...
                <div className="teamRow">
                    <div className="person">
                        <div className="container">
                            <img className="personImg" src={rishiImg} alt="Rishi"></img>
                    ...
                    <div className="person">
                        <div className="container">
                            <img className="personImg" src={arghyaImg} alt="Arghya"></img>
                            <div className="teamOverlay">
                    ...
                    <div className="person">
                        <div className="container">
                            <img className="personImg" src={maneeshImg} alt="Maneesh"></img>
                            <div className="teamOverlay">
                    ...
                    <div className="person">
                        <div className="container">
                            <img className="personImg" src={samratImg} alt="Samrat"></img>
                            <div className="teamOverlay">
